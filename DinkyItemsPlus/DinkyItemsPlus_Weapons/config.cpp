...
class CfgWeapons
{
	...
	class Archery_Base {itemSize[]={5,1};};
	class AKM: AKM_Base
	{
		itemSize[]={5,1};
		itemsCargoSize[]={0,0};
...
class cfgVehicles
{
	...
	class ItemSuppressor{itemSize[]={1,1};};
	class ItemBarrel;
	class Grenade_Base{itemSize[]={1,1};};
	class ItemGrenade{itemSize[]={1,1};};
...
{
	class DefaultAmmo;
	class HandGrenade_Base{ itemSize[]={1,1}; };
	class Shotgun_Base;
	class Bullet_Base{ itemSize[]={1,1}; };
