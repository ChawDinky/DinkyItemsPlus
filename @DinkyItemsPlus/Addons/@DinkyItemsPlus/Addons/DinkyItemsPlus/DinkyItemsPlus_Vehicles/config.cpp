////////////////////////////////////////////////////////////////////
//DeRap: DinkyItemsPlus\DinkyItemsPlus_Vehicles\config.bin
...
class CfgPatches
{
	...
	{
		units[] = {"CarWheel","CarDoor","HatchbackWheel","HatchbackWheel_Ruined","HatchbackDoors_Driver","HatchbackHood","HatchbackTrunk","TruckBattery","CarBattery","AircraftBattery","TruckExhaust","EngineBelt","BrakeFluid","EngineOil","CarRadiator","TruckRadiator","TireRepairKit","HeadlightH7","WindscreenBox","GlowPlug","SparkPlug","HeadlightH7_Box","CanisterGasoline"};
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Data","DZ_Vehicles_Wheeled","DZ_Vehicles_Parts"};
	};
};
class CfgVehicles
{
