////////////////////////////////////////////////////////////////////
//DeRap: DinkyItemsPlus\config.bin
...
class CfgMods
{
	class DinkyItemsPlus
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"DinkyItemsPlus/scripts/4_World"};
			};
			class missionScriptModule
			{
				value = "";
				files[] = {"DinkyItemsPlus/scripts/5_Mission"};
			};
		};
	};
};
