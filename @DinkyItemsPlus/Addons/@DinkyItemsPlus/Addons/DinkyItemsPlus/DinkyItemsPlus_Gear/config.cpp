////////////////////////////////////////////////////////////////////
//DeRap: DinkyItemsPlus\DinkyItemsPlus_Gear\config.bin
...
class CfgPatches
{
	class DinkyItemsPlus_Gear
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Data","DZ_Gear_Books","DZ_Gear_Camping","DZ_Gear_Consumables","DZ_Gear_Containers","DZ_Gear_Cooking","DZ_Gear_Crafting","DZ_Gear_Cultivation","DZ_Gear_Drinks","DZ_Gear_Food","DZ_Gear_Medical","DZ_Gear_Navigation","DZ_Gear_Optics","DZ_Radio","DZ_Gear_Tools","DZ_Gear_Traps"};
		ammo[] = {"LandMineExplosion"};
	};
};
class CfgVehicles
{
